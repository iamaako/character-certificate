...
================================================================================*/ !(function (
  ...
  var c,
    ...
    m = function (a) {
      ...
      var c = Math.abs(a.pageX - e.pageX),
        ...
        f = Math.max(c, d);
      return (
        Math.abs(a.timeStamp - e.timeStamp) < 750 && f < b.tap.POSITION_DELTA
      );
    },
    n = function (a) {
    ...
    o = {
            ...
            o.isTracking ||
              ((a.touches || !m(a)) &&
                ...
                a.touches
                  ? ((e = a),
                    c
                      .on("touchend" + f + g, o.onEnd)
                      .on("touchcancel" + f + g, o.onCancel))
      ...
      onEnd: function (a) {
        ...
        a.isTrigger ||
          (n(a),
          l(a) && ((c = k(h, a)), (d = c), b(j.event.target).trigger(c)),
          o.onCancel(a));
      },
      onCancel: function (a) {
        a && "touchcancel" === a.type && a.preventDefault(),
          (o.isTracking = !1),
          c.off(g);
      },
      onClick: function (a) {
  ...
  b(a).ready(o.enable),
    (b.tap = { POSITION_DELTA: 10, TIME_DELTA: 400, LEFT_BUTTON_ONLY: !0 });
})(document, jQuery);
...
================================================================================*/ jQuery(
  ...
  if (
    /MSIE\s([\d.]+)/.test(navigator.userAgent)
      ? new Number(RegExp.$1) < 10
      : false
  ) {
  ...
  $toggles.each(function () {
    var $this = $(this),
      ...
      direction =
        ($("html").attr("dir") == "rtl" && $this.data("pos") != "right") ||
        ($("html").attr("dir") != "rtl" && $this.data("pos") == "right")
          ? "right"
          : "left";
    ...
    var inside_effect = [
      "off-canvas-effect-3",
      "off-canvas-effect-16",
      "off-canvas-effect-7",
      "off-canvas-effect-8",
      "off-canvas-effect-14",
    ];
  ...
  $toggles.on("tap", function (e) {
    ...
    direction =
      ($("html").attr("dir") == "rtl" && $btn.data("pos") != "right") ||
      ($("html").attr("dir") != "rtl" && $btn.data("pos") == "right")
        ? "right"
        : "left";
    ...
    $wrapper[0].className =
      $.trim(
        $wrapper[0].className.replace(/\s*off\-canvas\-effect\-\d+\s*/g, " ")
      ) +
      " " +
      $btn.data("effect") +
      " " +
...
!(function ($) {
  if ($.browser == undefined || $.browser.msie == undefined) {
    ...
    if (
      (match =
        ...
        navigator.userAgent.match(/Trident.*rv:([0-9]{1,}[\.0-9]{0,})/))
    ) {
      $.browser.msie = true;
        ...
        Element.implement({
          show: function (args) {
            if (
              ...
              arguments.callee.caller
                .toString()
                .indexOf("isPropagationStopped") !== -1
            ) {
              return this;
            }
  ...
  $(window).on("load", function () {
    if (
      !$(document.documentElement).hasClass("off-canvas-ready") &&
        ...
        btn.on("click", function () {
          ...
          if (!$.support.transition) {
            nav
              ...
              .css(
                "height",
                !btn.hasClass("collapsed") && btn.data("t3-clicked")
                  ? ""
                  : wheight
              );
...
================================================================================*/ (function (
  ...
  T3Menu.prototype = {
    ...
    start: function () {
      ...
      $(document.body).on("tap hideall.t3menu", function (e) {
        ...
        self.timer = setTimeout(
          $.proxy(self.hide_alls, self),
          e.type == "tap" ? 500 : self.options.hidedelay
        );
      });
      ...
      if ($megatab.length) {
        $megatab.each(function () {
          ...
          var megatabs = $parentItem.data("mega-tabs")
            ? $parentItem.data("mega-tabs")
            : [];
          megatabs.push($tabul);
          ...
          $p.each(function () {
            var $this = $(this);
            $this
              .data("prev-style", $this.attr("style"))
          ...
          $tabs.each(function () {
            ...
            tabheight = Math.max(tabheight, $this.children().innerHeight());
            if (thisstyle) {
    ...
    hide: function (item, $target) {
      ...
      item.ftimer = setTimeout(
        $.proxy(this.hidden, this, item),
        this.options.duration
      );
      this.timer = setTimeout(
        $.proxy(this.hide_alls, this),
    ...
    position: function ($item) {
      ...
      if (level == 1) {
        ...
        if (align == "center") {
          ...
          align_offset =
            offset.left +
            ((align == "left" && this.options.rtl) ||
            (align == "right" && !this.options.rtl)
              ? width
              : 0);
        }
        if (this.options.rtl) {
          if (align == "right") {
            ...
            if (
              align_offset < (align == "center" ? sub_width / 2 : sub_width)
            ) {
              align_delta =
                align_offset - (align == "center" ? sub_width / 2 : sub_width);
            ...
            if (
              ...
              sub.css(
                "right",
                align_offset +
                  (align == "center" ? (sub_width + width) / 2 : 0) +
                  align_trans -
                  screen_width
              );
            }
          ...
          if (align == "right") {
            ...
            if (
              ...
              align_delta =
                screen_width -
                align_offset -
                (align == "center" ? sub_width / 2 : sub_width);
        ...
        if (this.options.rtl) {
          if (
            $item
              .closest(".mega-dropdown-menu")
              .parent()
              .hasClass("mega-align-right")
          ) {
      ...
      g = function (e, i) {
        ...
        e.find("img, iframe").each(function () {
          t(this).is("img") &&
            t(this).attr(
              "src",
              t(this).attr("src") + "?timestamp=" + new Date().getTime()
            ),
...
jQuery(document).ready(function ($) {
  $("#style-switcher h2 a").click(function (e) {
    ...
    if (div.css("left") === "-186px") {
      ...
      $("#style-switcher").animate({ left: "-186px" });
    }
  });
  $("#layout-style").change(function (e) {
    if ($(this).val() == 1) {
      $("body").removeClass("jb-boxed"), $(window).resize();
      stickyheader = !stickyheader;
    } else {
      $("body").addClass("jb-boxed"), $(window).resize();
      stickyheader = !stickyheader;
    }
  });
  $(".bg li a").click(function () {
    var current = $("#style-switcher select[id=layout-style]")
